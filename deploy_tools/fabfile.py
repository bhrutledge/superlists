...
REPO_URL = 'https://github.com/bhrutledge/superlists.git'
SITES_FOLDER = '/home/rutt/Code'

env.shell = 'BASH_ENV=/home/rutt/.bashrc /bin/bash -c'
...
def _restart_server(source_folder):
    run('cd %s && ../admin restart' % (source_folder))
